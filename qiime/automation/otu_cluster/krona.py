...
def krona_main(otu_table, krona_path):
    builder = KronaBuilder()
    builder.otuTablePathListToKrona(otu_table, krona_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--otu_tables',
                         help='OTU tables generated by community_profile.py to use, comma separated', required=True)
    parser.add_argument('-o', '--output_krona', help='Output filename for krona [default: "CommunityM.html"]',
                        default="CommunityM.html")
